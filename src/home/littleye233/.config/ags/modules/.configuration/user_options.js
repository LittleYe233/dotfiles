...
function overrideConfigRecursive(userOverrides, configOptions = {}, check = true) {
    for (const [key, value] of Object.entries(userOverrides)) {
        ...
        /// @note The latest commit (4ed4bf2) brings a bug of failure to override
        /// default configurations. Here I reset it to an earlier version (at
        /// commit 10b3ead). For more information see the comments of the
        /// malformed commit.
        } else {
